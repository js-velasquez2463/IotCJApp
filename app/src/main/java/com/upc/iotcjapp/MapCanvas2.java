...
public class MapCanvas2 extends LineChart {
    ...
    public MapCanvas2(Context context) {
        super(context);
        initChart();
    }

    public MapCanvas2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initChart();
    }

    public MapCanvas2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initChart() {
        ...
        LineDataSet dataSet = new LineDataSet(entries, "Velocity x");
        ...
        LineDataSet dataSet2 = new LineDataSet(entries2, "Velocity y");
    ...
    public void restartPoints() {
        ...
        if (lineData != null) {
            ...
            LineDataSet dataSet2 = (LineDataSet) lineData.getDataSetByIndex(1);
            if (showVelocity) {
                dataSet.setLabel("Velocity x");
                dataSet2.setLabel("Velocity y");
            } else {
                dataSet.setLabel("Distance x");
                dataSet2.setLabel("Distance y");
            }
            dataSet.clear();
            dataSet2.clear();
            invalidate();
